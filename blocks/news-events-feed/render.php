...
$view_all_text = get_field('view_all_text') ?: 'View All News & Events';
$view_all_link = get_field('view_all_link');

// Set default link URL if not set
$view_all_url = ! empty( $view_all_link['url'] ) ? $view_all_link['url'] : get_post_type_archive_link('post');
$view_all_target = ! empty( $view_all_link['target'] ) ? $view_all_link['target'] : '';
...
<div class="block-news-events-feed">
	<div class="u-width-constrained">
		<div class="news-events-feed__header">
			...
			<a href="<?php echo esc_url( $view_all_url ); ?>" class="news-events-feed__view-all"<?php echo ! empty( $view_all_target ) ? ' target="' . esc_attr( $view_all_target ) . '"' : ''; ?>>
